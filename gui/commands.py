...
def get_frame(m, t, entry_type, s, data):
    ...
    e = {
        ...
        'combo': ttk.Combobox(f, values=[d[1] for d in data])
...
def get_rwi_widgets(m):
    ...
    return {
        ...
        wt: get_frame(m, 'Тип работы', 'combo', tk.TOP, get_db_data(wt)).grid(row=0, column=1, padx=10, pady=5, sticky=tk.EW),
